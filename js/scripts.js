document.addEventListener("DOMContentLoaded", function () {
	...
	document.querySelectorAll("button#group-button").forEach((element) => {
	...
	document
		.querySelectorAll("#sign-in-btn")
		.forEach((element) => element.addEventListener("click", switchToSignIn));
	document
		.querySelectorAll("#sign-up-btn")
		.forEach((element) => element.addEventListener("click", switchToSignUp));
